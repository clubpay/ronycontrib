...
require (
	github.com/clubpay/ronykit v0.4.11
...
require (
	...
	github.com/fasthttp/websocket v1.5.1-rc.2 // indirect
	...
	github.com/goccy/go-reflect v1.1.1-0.20210520085854-e1eb8c5193d0 // indirect
